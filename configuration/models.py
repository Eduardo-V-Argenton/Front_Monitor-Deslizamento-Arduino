...
class SensorModule(Module):
    ...
    accel_default_x = models.FloatField(default=0, blank=False, null=False)
    accel_default_y = models.FloatField(default=0, blank=False, null=False)
    accel_default_z = models.FloatField(default=0, blank=False, null=False)
